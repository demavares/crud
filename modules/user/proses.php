...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	if ($_GET['act']=='insert') {
		if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO usuarios(username,password,name_user,email,telefono,permisos_acceso)
                                            VALUES('$username','$password','$name_user','$email','$telefono','$permisos_acceso')")
	...
	/* Modificar y/o actualizar Usuarios */
